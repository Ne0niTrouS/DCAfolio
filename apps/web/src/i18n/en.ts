...
export const en = {
  ...
  'dashboard.viewAllHoldings': 'View all {count} holdings',
  'dashboard.showFewer': 'Show fewer',
  'dashboard.emptyTitle': 'No investments yet.',
  'dashboard.emptyBody': 'Recorded purchases appear here once you have some.',
  'dashboard.costVsValue': 'Cost vs current value',
  'dashboard.valueVsCostHint': 'Worth {percent}% of what you put in',
  'dashboard.notEnoughHistory': 'Not enough data to show a trend yet',
  'dashboard.historyHint': 'A trend appears once purchases are recorded on more than one date.',
  'dashboard.singlePointDate': 'Invested on {date}',
  ...
  'market.heading': 'Market data',
  'market.updatedAgo': 'Updated {time}',
  'market.mayBeOutdated': 'Prices may be out of date',
  'market.lastUpdatedAt': 'last updated {at}',
  'market.noPricesYet': 'No price data yet',
  'market.pricesUnavailable': 'Could not load prices right now.',
  'market.source': 'Source: {source}',
  'market.sync': 'SyncData',
  'market.syncing': 'Updating prices…',
  'market.syncDoneTitle': 'Prices updated',
  'market.syncPartialTitle': 'Some prices updated',
  'market.syncFailedTitle': 'Could not update prices',
  'market.syncCount': 'updated {captured}/{total}',
