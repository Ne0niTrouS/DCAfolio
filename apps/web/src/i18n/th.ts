...
export const th: Dictionary = {
  ...
  'dashboard.singlePointDate': 'ลงทุนเมื่อ {date}',
  ...
  'market.heading': 'ข้อมูลราคาตลาด',
  'market.updatedAgo': 'อัปเดตล่าสุด {time}',
  'market.mayBeOutdated': 'ข้อมูลราคาอาจล้าสมัย',
  'market.lastUpdatedAt': 'อัปเดตล่าสุด {at}',
  ...
  'market.syncFailedTitle': 'อัปเดตราคาไม่สำเร็จ',
  'market.syncCount': 'อัปเดต {captured}/{total} รายการ',
